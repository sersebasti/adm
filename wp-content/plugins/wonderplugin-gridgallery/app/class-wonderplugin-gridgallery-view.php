...
class WonderPlugin_Gridgallery_View {
	...
	function add_metaboxes() {
		add_meta_box('overview_features', __('Wonder Grid Gallery Features', 'wonderplugin_gridgallery'), array($this, 'show_features'), 'wonderplugin_gridgallery_overview', 'features', '');
	...
	function print_overview() {
		...
		<h2><?php echo __( 'Wonder Grid Gallery', 'wonderplugin_gridgallery' ) . ( (WONDERPLUGIN_GRIDGALLERY_VERSION_TYPE == "C") ? " Pro" : ( (WONDERPLUGIN_GRIDGALLERY_VERSION_TYPE == "L") ? " Lite" : " Trial" ) ) . " Version " . WONDERPLUGIN_GRIDGALLERY_VERSION; ?> </h2>
	...
	function print_edit_settings() {
		...
		$printlightboxoptionsinfooter = $settings['printlightboxoptionsinfooter'];
		$printlightboxoptions = $settings['printlightboxoptions'];
		...
		<tr>
			...
			<td><label><input name='jetpackdisablelazyload' type='checkbox' id='jetpackdisablelazyload' <?php echo ($jetpackdisablelazyload == 1) ? 'checked' : ''; ?> /> Disable Jetpack lazy load for grid thumbnail images</label>
			</td>
		</tr>

		<tr>
			<th>Lightbox Options</th>
			<td><label><input name='printlightboxoptionsinfooter' type='checkbox' id='printlightboxoptionsinfooter' <?php echo ($printlightboxoptionsinfooter == 1) ? 'checked' : ''; ?> /> Print Lightbox options in footer</label>
			<p><label><input name='printlightboxoptions' type='checkbox' id='printlightboxoptions' <?php echo ($printlightboxoptions == 1) ? 'checked' : ''; ?> /> Print Lightbox options with each gallery</label></p>
			</td>
		</tr>
	...
	function print_register() {
		...
		function validateLicenseForm() {
			...
			if (jQuery.trim(jQuery("#wonderplugin-gridgallery-key").val()).length <= 0)
			{
	...
	function save_item_post($item_post) {
		...
		?>
			...
			{
				echo "<h2>Wonder Grid Gallery</h2>";
	...
	function import_export()
	{
		?>
			<div class="wrap">
				...
				<h2>
					<?php _e( 'Tools', 'wonderplugin_gridgallery' ); ?>
				</h2>
				...
				<ul class="wonderplugin-tab-buttons-horizontal"
					...
					<li class="wonderplugin-tab-button-horizontal"><span class="dashicons dashicons-desktop" style="margin-right:8px;"></span><?php _e( 'PHP Info', 'wonderplugin_gridgallery' ); ?></li>
				</ul>
