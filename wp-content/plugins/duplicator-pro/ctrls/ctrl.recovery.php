...
class DUP_PRO_CTRL_recovery
{
    ...
    public static function addHelp($currentScreen)
    {
        ...
        $currentScreen->add_help_tab(array(
            ...
            'content' => DupProSnapLibIOU::getInclude(DUPLICATOR_PRO_PLUGIN_PATH.'/views/tools/recovery/recovery-help-main.php')
        ));

        $currentScreen->add_help_tab(array(
            'id'      => 'dup-pro-help-tab-recovery-faq',
            'title'   => DUP_PRO_U::__('FAQ'),
            'content' => DupProSnapLibIOU::getInclude(DUPLICATOR_PRO_PLUGIN_PATH.'/views/tools/recovery/recovery-help-faq.php')
        ));

        $currentScreen->add_help_tab(array(
            'id'      => 'dup-pro-help-tab-recovery-cases',
            'title'   => DUP_PRO_U::__('Example Usage'),
            'content' => DupProSnapLibIOU::getInclude(DUPLICATOR_PRO_PLUGIN_PATH.'/views/tools/recovery/recovery-help-example-usage.php')
        ));
    ...
    public static function actionResetRecoveryPoint()
    {
        try {
            if (file_exists(DUPLICATOR_PRO_PATH_RECOVER)) {
                DupProSnapLibIOU::rrmdir(DUPLICATOR_PRO_PATH_RECOVER);
            }
    ...
    {
        try {
            $recPackageId = DupProSnapLibUtil::filterInputRequest('recovery_package', FILTER_VALIDATE_INT);
