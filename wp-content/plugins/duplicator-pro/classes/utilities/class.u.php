...
class DUP_PRO_U
{
    ...
    public static function initStorageDirectory()
    {
        ...
        $path_ssdir_tmp        = DupProSnapLibIOU::safePath(DUPLICATOR_PRO_SSDIR_PATH_TMP);
        $path_ssdir_tmp_import = DupProSnapLibIOU::safePath(DUPLICATOR_PRO_SSDIR_PATH_TMP_IMPORT);
        $path_plugin           = DupProSnapLibIOU::safePath(DUPLICATOR_PRO_PLUGIN_PATH);
        $path_import           = DupProSnapLibIOU::safePath(DUPLICATOR_PRO_PATH_IMPORTS);
