...
class DUP_PRO_Storage_Entity extends DUP_PRO_JSON_Entity_Base
{
    ...
    {
        $parsetUrl             = DupProSnapLibURLU::parseUrl(get_home_url());
        ...
        return ltrim(DupProSnapLibURLU::buildUrl($parsetUrl), '/\\');
    }
        ...
        if (file_exists($source_archive_filepath)) {
            if (file_exists($source_installer_filepath)) {
                ...
                if ($this->ftp_use_curl) {
                    $ftp_client = new DUP_PRO_FTPcURL($this->ftp_server, $this->ftp_port, $this->ftp_username, $this->ftp_password, $this->ftp_storage_folder, $this->ftp_timeout_in_secs, $this->ftp_ssl,
                ...
                if ($this->ftp_use_curl || $ftp_client->open()) {
                    ...
                    try {
                        ...
                        if ($upload_info->copied_archive == false) {
                            ...
                            $ftp_upload_info = $ftp_client->upload_chunk($source_archive_filepath, $this->ftp_use_curl ? '' :$this->ftp_storage_folder, $global->php_max_worker_time_in_sec,
