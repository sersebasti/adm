        ...
        <thead>
            <tr>
                <td colspan="2 ">
                    ...
                    <?php echo DUP_PRO_U::esc_html__("We've included some big features in recent releases.  Here are the highlights:"); ?>
                </td>
            </tr>
        </thead>
        <tbody>
            <tr>
                ...
                <td>
                    ...
                    " <a href='{$import_tab_url}'>".DUP_PRO_U::esc_html__('Duplicator Pro > Import.').'</a>';
                    ?>
                </td>
            </tr>
            <tr>
