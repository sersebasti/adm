...
<tr <?php echo $idHtml; ?>class="<?php echo implode(' ', $rowClasses) ?>" data-path="<?php echo esc_attr($archivePath); ?>" >
    <td class="name" >
        ...
        <div class="dup-pro-import-package-detail dup-pro-recovery-details-max-width-wrapper no-display" >
    ...
    <td class="funcs">
        <div class="actions <?php echo $funcsEnalbed ? '' : 'no-display'; ?>" >
            ...
            <span class="separator-2x" ></span>
            <button 
                type="button" 
                class="dup-pro-import-action-install button button-primary" 
