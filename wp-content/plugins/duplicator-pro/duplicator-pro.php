...
HTML;
    ...
    function duplicator_pro_init()
    {
        ...
        if (!function_exists('wp_doing_ajax') || (!wp_doing_ajax() )) {
            ...
            wp_register_style('tippy', DUPLICATOR_PRO_PLUGIN_URL.'assets/js/tippy/tippy.css', null, '3.0.3');
            ...
            wp_register_script('popper', DUPLICATOR_PRO_PLUGIN_URL.'assets/js/tippy/popper.min.js', '2.4.4');
            wp_register_script('tippy', DUPLICATOR_PRO_PLUGIN_URL.'assets/js/tippy/tippy-bundle.umd.min.js', '6.2.6');
    ...
    function duplicator_pro_get_menu()
    {
        ...
        switch ($current_page) {
            ...
            case DUP_PRO_Constants::$SETTINGS_SUBMENU_SLUG:
                require(DUPLICATOR_PRO_PLUGIN_PATH.'/ctrls/ctrl.storage.setting.php');
