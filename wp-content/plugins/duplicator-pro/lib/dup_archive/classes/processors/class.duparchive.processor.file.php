...
if (!class_exists('DupArchiveFileProcessor')) {
    ...
    class DupArchiveFileProcessor
    {
        ...
        {
            if ($expandState->skipWpCoreFiles && DupProSnapLibUtilWp::isWpCore($expandState->currentFileHeader->relativePath, DupProSnapLibUtilWp::PATH_RELATIVE)) {
                return true;
            }
        ...
        {
            if ($expandState->skipWpCoreFiles && DupProSnapLibUtilWp::isWpCore($directoryHeader->relativePath, DupProSnapLibUtilWp::PATH_RELATIVE)) {
                return true;
            }
        ...
        public static function setFileMode($expandState, $filePath)
        {
            ...
            DupProSnapLibIOU::chmod($filePath, $expandState->fileModeOverride);
        }
