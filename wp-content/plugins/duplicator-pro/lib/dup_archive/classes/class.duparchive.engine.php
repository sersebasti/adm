...
//        $expandState->basePath    = $destPath . '/tempExtract';   // RSR remove once extract works
        ...
        {
            if ($expandState->skipWpCoreFiles && DupProSnapLibUtilWp::isWpCore($candidate, DupProSnapLibUtilWp::PATH_RELATIVE)) {
                return true;
            }

            $directoryFilters = $expandState->filteredDirectories;
        ...
        {
            $excludedDirectories = $expandState->filteredDirectories;
            $excludedFiles       = $expandState->filteredFiles;
            $includedFiles       = $expandState->includedFiles;
