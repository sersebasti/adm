...
class DUPX_WPConfig
{
    ...
    public static function getWpConfigPath()
    {
        ...
        $origWpDir        = DupProSnapLibIOU::safePath(dirname($origWpConfTarget));
        if ($origWpDir === DUPX_Paramas_Manager::getInstance()->getValue(DUPX_Paramas_Manager::PARAM_PATH_NEW)) {
            return $origWpConfTarget;
        } else {
            return DUPX_Paramas_Manager::getInstance()->getValue(DUPX_Paramas_Manager::PARAM_PATH_WP_CORE_NEW)."/wp-config.php";
        }
    }
