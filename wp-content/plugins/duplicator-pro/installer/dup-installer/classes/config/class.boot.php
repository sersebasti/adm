...
class DUPX_Boot
{
    ...
    protected static function initInstallerFiles()
    {
        ...
        if (self::isInit()) {
            ...
            DUPX_Log::info("If start step 0 ".$paramManager->getValue(DUPX_Paramas_Manager::PARAM_PATH_NEW));
            ...
            try {
                ...
                DUPX_Log::logException($e, 'CANT RESTORE CONFIG FILES FORM PREVISION INSTALLATION');
    ...
    protected static function initLogHeader()
    {
        ...
        DUPX_Log::info(str_pad('ARCHITECTURE', $labelPadSize, '_', STR_PAD_RIGHT).': '.DupProSnapLibUtil::getArchitectureString());
