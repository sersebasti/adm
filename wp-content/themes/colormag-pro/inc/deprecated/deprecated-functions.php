...
if ( ! function_exists( 'colormag_breaking_news_duration_setting_options_sanitize' ) ) :
	 ...
	 * @param WP_Customize_Setting $setting Setting instance.
	 */
	function colormag_breaking_news_duration_setting_options_sanitize( $val, $setting = array() ) {
...
if ( ! function_exists( 'colormag_breaking_news_speed_setting_options_sanitize' ) ) :
	 ...
	 * @param WP_Customize_Setting $setting Setting instance.
	 */
	function colormag_breaking_news_speed_setting_options_sanitize( $val, $setting = array() ) {
