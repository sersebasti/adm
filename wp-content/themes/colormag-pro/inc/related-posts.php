...
$related_posts_data           = get_theme_mod( 'colormag_related_posts_layout', 'style_one' );
		...
		<div class="related-posts clearfix <?php echo esc_attr( $related_posts_carousel_class ); ?>">
			...
			while ( $related_posts->have_posts() ) :
				...
				<div class="single-related-posts">
					...
					<?php if ( has_post_thumbnail() && 'style_three' != get_theme_mod( 'colormag_related_posts_layout', 'style_one' ) ): ?>
					...
					<div class="article-content">
						...
						<?php
						if ( 'style_three' != get_theme_mod( 'colormag_related_posts_layout', 'style_one' ) ) :
							colormag_entry_meta( false );
						endif;

						if ( 'style_two' == get_theme_mod( 'colormag_related_posts_layout', 'style_one' ) ) {
							?>
