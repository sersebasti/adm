...
class ColorMag_Elementor_Widgets_Trending_News extends Colormag_Elementor_Widget_Base {
	...
	protected function render() {
		...
		<div class="clearfix tg-module-block tg-module-wrapper swiper-container tg-trending-news" data-speed="<?php echo absint( $transition_speed ); ?>">
			...
			<div class="swiper-wrapper trending-news-wrapper">
				...
				while ( $get_featured_posts->have_posts() ) :
					...
					<div class="tg-col-control swiper-slide trending-news-slide" data-swiper-autoplay="<?php echo absint( $transition_time ); ?>">
