...
if ( ! function_exists( 'colormag_widgets_classes' ) ) :
	...
	function colormag_widgets_classes() {
		...
		$sidebar_class = array(
			...
			'colormag_news_in_picture_widget'          => 'widget_block_picture_news widget_highlighted_posts widget_featured_meta widget_featured_posts',
			'colormag_default_news_widget'             => 'widget_default_news_colormag widget_featured_posts',
			'colormag_tabbed_widget'                   => 'widget_tabbed_colormag widget_featured_posts',
			'colormag_random_post_widget'              => 'widget_random_post_colormag widget_featured_posts',
			'colormag_slider_news_widget'              => 'widget_slider_news_colormag widget_featured_posts',
			'colormag_breaking_news_widget'            => 'widget_breaking_news_colormag widget_featured_posts',
			'colormag_ticker_news_widget'              => 'widget_ticker_news_colormag widget_featured_posts',
			'colormag_featured_posts_small_thumbnails' => 'widget_featured_posts widget_featured_posts_small_thumbnails widget_featured_meta',
