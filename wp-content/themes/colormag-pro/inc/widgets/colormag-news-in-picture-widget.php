...
class colormag_news_in_picture_widget extends ColorMag_Widget {
	...
	public function __construct() {
		...
		$this->widget_cssclass             = 'widget_block_picture_news widget_highlighted_posts widget_featured_meta widget_featured_posts';
		...
		$this->settings                    = array(
			'widget_layout'            => array(
				...
				'image_url' => get_template_directory_uri() . '/img/style-5.jpg',
			),
			'title'                    => array(
				'type'    => 'text',
				'default' => '',
	...
	public function widget( $args, $instance ) {
		...
		if ( ( false === $slide ) && ( is_active_widget( false, false, $this->id_base ) || is_customize_preview() || colormag_elementor_active_page_check() ) ) {
