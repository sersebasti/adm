...
class colormag_breaking_news_widget extends ColorMag_Widget {
	...
	public function __construct() {
		...
		$this->widget_cssclass             = 'widget_breaking_news_colormag widget_featured_posts';
	...
	public function widget( $args, $instance ) {
		...
		<div class="breaking_news_widget_inner_wrap">
			...
			<ul id="breaking-news-widget_<?php echo esc_attr( $this->id ); ?>" class="breaking-news-widget-slide"
