...
class colormag_featured_posts_small_thumbnails extends ColorMag_Widget {
	...
	public function __construct() {
		...
		$this->widget_cssclass    = 'widget_featured_posts widget_featured_posts_small_thumbnails widget_featured_meta';
		...
		$this->settings           = array(
			'widget_layout'   => array(
				...
				'image_url' => get_template_directory_uri() . '/img/style-3.jpg',
			),
			'title'           => array(
				'type'    => 'text',
				'default' => '',
