...
class colormag_tabbed_widget extends ColorMag_Widget {
	...
	public function __construct() {
		...
		$this->widget_cssclass    = 'widget_tabbed_colormag widget_featured_posts';
	...
	public function widget( $args, $instance ) {
		...
		$available_tabs     = array(
			'popular-tab' => __( '<i class="fa fa-star"></i>Popular', 'colormag' ),
			'recent-tab'  => __( '<i class="fa fa-history"></i>Recent', 'colormag' ),
			'comment-tab' => __( '<i class="fa fa-comment"></i>Comment', 'colormag' ),
		);
		...
		<div class="tabbed-widget">
			<ul class="widget-tabs column-<?php echo absint( $tabs_number ); ?>">
