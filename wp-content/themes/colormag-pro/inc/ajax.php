...
function colormag_load_scripts() {
	...
	wp_localize_script( 'colormag-infinite-scroll', 'colormagInfiniteScrollParams', apply_filters( 'colormag_infinite_scroll_params', array() ) );
...
function colormag_ajax_single_post_navigation() {
	...
	if ( is_attachment() ) :
		...
		if ( 'small_featured_image' === get_theme_mod( 'colormag_post_navigation', 'default' ) ) :
			...
			<?php
		elseif ( 'medium_featured_image' === get_theme_mod( 'colormag_post_navigation', 'default' ) ) :
